...
partial class Program{
    ...
    {  
        ...
        while(op!=1 ||op!=2)
        {
            ...
            WriteLine("1. All history of maintenance separated by equipment");
    ...
    public static void ViewMaintenanceHistoryByEquipment(){
        ...
        using(bd_storage db = new())
        {
            ...
            .Include(m=>m.Maintenance).Include(m=>m.Maintenance.MaintenanceType).Include(m=>m.Equipment).Include(m=>m.Maintenance.Storer).OrderBy(m=>m.MaintenanceId).OrderByDescending(m=>m.Maintenance.ProgrammedDate);
